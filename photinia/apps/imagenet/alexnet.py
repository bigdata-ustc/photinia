...
class AlexNet(ph.Widget):
    ...
    def _setup(self, x):
        return ph.setup(
            x - self._mean, [
                self._conv_1, tf.nn.relu, self._lrn, self._pool_1, 'map_1',
                self._conv_2, tf.nn.relu, self._lrn, self._pool_2, 'map_2',
                self._conv_3, tf.nn.relu, 'map_3',
                self._conv_4, tf.nn.relu, 'map_4',
                self._conv_5, tf.nn.relu, self._pool_5, 'map_5',
                ph.ops.flatten, 'feature_5',
                self._dense_6, tf.nn.relu, 'feature_6',
                self._dense_7, tf.nn.relu, 'feature_7',
