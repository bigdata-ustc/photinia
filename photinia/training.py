...
class Trainer(widgets.Widget):
    ...
    def fit(self, max_loop=10000, fitters=None):
        ...
        Args:
            max_loop (int):
                The max number of fitting(always refers to training) iterations.
                Here, "a training iteration" usually means train the model with one batch of data.
            fitters (list[Fitter]|tuple[Fitter]):
                Additional fitter objects whose "fit()" method will be called in the iterations.
                The fitters here will be called after those added from "add_*_fitter()" methods.
